...
const groceries = [
    ...
    { id: '2', name: 'Wheat', brand: 'Premium Brand', price: 40, image: require('../assets/item1.jpg') },
    { id: '3', name: 'Rice', brand: 'Good Brand', price: 50, image: require('../assets/item1.jpg') },
    { id: '4', name: 'Wheat', brand: 'Premium Brand', price: 40, image: require('../assets/item1.jpg') },
    { id: '5', name: 'Rice', brand: 'Good Brand', price: 50, image: require('../assets/item1.jpg') },
    { id: '6', name: 'Wheat', brand: 'Premium Brand', price: 40, image: require('../assets/item1.jpg') },
];

export default function GroceriesScreen({ addToCart }) {
    return (
